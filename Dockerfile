...
# and other autotools files for GMP, MPFR, MPC, ISL, and Expat before building using modern
# autoconf 2.71 (Ubuntu 22.04 default). Only binutils/gcc/gdb/newlib use legacy autoconf 2.69.
